...
declare module 'vscode' {
	...
	*/
	...
	/**
	 * Denotes a column in the Essence window. Columns are
	...
	export namespace env {
		...
		/**
		 * The application name of the editor, like 'Essence'.
		 *
		 * @readonly
		 */
	...
	export namespace workspace {
		...
		/**
		 * The folder that is open in Essence. `undefined` when no folder
		 * has been opened.
		 *
		 * @readonly
		 */
 ...
 * we recommend the use of native promises which are available in Essence.
 */

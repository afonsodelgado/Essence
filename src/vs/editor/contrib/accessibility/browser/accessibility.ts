...
import { editorWidgetBackground, contrastBorder } from 'vs/platform/theme/common/colorRegistry';
...
class AccessibilityHelpWidget extends Widget implements IOverlayWidget {
	...
	private _buildContent() {
		...
		let text = nls.localize('introMsg', "Thank you for trying out Essence's accessibility options.");

...
suite('Labels', () => {
	...
	test('template', function () {
		...
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: '', rootName: '', appName: 'Essence', separator: { label: ' - ' } }), 'Essence');
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: 'Untitled-1', rootName: '', appName: 'Essence', separator: { label: ' - ' } }), 'Untitled-1 - Essence');
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: '', rootName: 'monaco', appName: 'Essence', separator: { label: ' - ' } }), 'monaco - Essence');
		assert.strictEqual(labels.template(t, { dirty: '', activeEditorShort: 'somefile.txt', rootName: 'monaco', appName: 'Essence', separator: { label: ' - ' } }), 'somefile.txt - monaco - Essence');
		assert.strictEqual(labels.template(t, { dirty: '* ', activeEditorShort: 'somefile.txt', rootName: 'monaco', appName: 'Essence', separator: { label: ' - ' } }), '* somefile.txt - monaco - Essence');
	});
});